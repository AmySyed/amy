    ...
    <main id="maincontent" role="main" class="page-content">
		...
		<?php if(get_theme_mod('driving_school_lite_404_button_label','404 Not Found')){ ?>
			<div class="read-moresec">
        		<a href="<?php echo esc_url( home_url() ); ?>" class="button"><?php echo esc_html( get_theme_mod('driving_school_lite_404_button_label',__('Return to the home page', 'driving-school-lite' )) ); ?><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('driving_school_lite_404_button_label',__('Return to the home page', 'driving-school-lite' )) ); ?></span></a>
			</div>
		<?php }?>
		</div>
