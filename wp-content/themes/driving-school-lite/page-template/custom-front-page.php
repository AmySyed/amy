...
<main id="maincontent" role="main">
  <?php if( get_theme_mod('driving_school_lite_slider_hide') != ''){ ?>
    <section id="slider">
      <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="<?php echo esc_attr(get_theme_mod('driving_school_lite_slider_speed',3000)); ?>"> 
        ...
        <?php if( get_theme_mod('driving_school_lite_slider_indicator',true) != ''){ ?>
          <ol class="carousel-indicators">
            <?php for($i=0;$i<count($driving_school_lite_content_pages);$i++) { ?>
