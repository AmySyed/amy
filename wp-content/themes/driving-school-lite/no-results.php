...
<?php else : ?>
	...
	<div class="read-moresec">
		<a href="<?php echo esc_url( home_url() ); ?>" class="button"><?php esc_html_e( 'Return to the home page', 'driving-school-lite' ); ?><span class="screen-reader-text"><?php esc_html_e('Return to the home page','driving-school-lite'); ?></span></a>
	</div>
<?php endif; ?>