...
<footer role="contentinfo" id="footer" class="copyright-wrapper">
  ...
  <div class="inner">
    <div class="copyright">
      <div class="container">
        <p><span class="black"><?php driving_school_lite_credit_link(); ?> <?php echo esc_html(get_theme_mod('driving_school_lite_text',__('By Themesglance','driving-school-lite'))); ?></span></p>
      </div>
      <hr class="dash">
    </div>
  </div>
